---
title: Home
description: Welcome to Physical AI & Humanoid Robotics - The Rise of the Digital Human
slug: /
sidebar_position: 0
---
...
Master the communication framework used by robots worldwide.

Learn to write Python code that controls real robots.
...
Each chapter builds on the last. By the end, you'll understand Physical AI and be ready to explore advanced topics.
